                                    ...
                                    <td colspan="5" class="px-5 py-4">
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button @click="saveEdit(dept)" class="p-2 text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 transition-colors" title="Simpan"><IconCheck :size="18" /></button>
