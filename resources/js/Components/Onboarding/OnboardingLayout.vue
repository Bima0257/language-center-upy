<script setup>
import { IconCircleCheck, IconCircleDot } from '@tabler/icons-vue';
...
const steps = [
    ...
    { label: 'Siap Ujian', icon: IconCircleDot },
];
</script>
...
<template>
    <div class="min-h-screen md:h-screen md:overflow-hidden bg-deep-space p-0 md:p-10">
        <div class="flex flex-col h-full max-w-[1440px] mx-auto overflow-hidden md:rounded-3xl shadow-standard">
            <div class="bg-white px-6 md:px-10 py-5 flex items-center gap-2 shrink-0 border-b border-outline-variant/30">
